...
== Gem also creates http_response method for ActiveResource::Connection class
Example
  ...
  #=> "260"
  #connection has last http response object , to access it use http_response method
