...
{<img src="https://secure.travis-ci.org/Fivell/activeresource-response.png" />}[http://travis-ci.org/Fivell/activeresource-response]  
{<img src="https://gemnasium.com/Fivell/activeresource-response.png" />}[https://gemnasium.com/Fivell/activeresource-response]  
{<img src="https://coveralls.io/repos/Fivell/activeresource-response/badge.png?branch=master" alt="Coverage Status" />}[https://coveralls.io/r/Fivell/activeresource-response?branch=master]
...
and paginate array directly by calling .paginate(options) with proper total/page/per_page values – see 
{source}[https://github.com/mislav/will_paginate/blob/master/lib/will_paginate/array.rb].
