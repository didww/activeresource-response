= Activeresource-response {<img src="https://secure.travis-ci.org/Fivell/activeresource-response.png" />}[http://travis-ci.org/Fivell/activeresource-response]  [![Build Status](https://secure.travis-ci.org/Fivell/activeresource-response.png)](http://travis-ci.org/Fivell/activeresource-response)
